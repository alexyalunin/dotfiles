...
```
brew install llvm cmake node graphviz boost hdf5 swig autojump ncdu tmux htop rg broot tldr wget fzf autossh
brew install --cask firefox google-chrome visual-studio-code telegram rectangle vlc eul docker jetbrains-toolbox github maccy transmission bitwarden 
```
...
- vscode: file -> auto save, Keyboard Shortcuts -> navigate back: cmd [, navigate forward: cmd ]. Settings -> settings -> off Copy With Syntax Highlighting
